FROM gradle:8.5.0-jdk17@sha256:eedefdfb01a1a0fe07699ecdc3ffad46d7fd620c45472ac42d774df5298b2514 AS cache
WORKDIR /app
ENV GRADLE_USER_HOME /app/gradle
COPY *.gradle.kts gradle.properties /app/
RUN gradle shadowJar --parallel --console=verbose

FROM gradle:8.5.0-jdk17@sha256:eedefdfb01a1a0fe07699ecdc3ffad46d7fd620c45472ac42d774df5298b2514 AS build
WORKDIR /app
