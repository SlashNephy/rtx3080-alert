FROM gradle:8.5.0-jdk17@sha256:30f979b5b89a14bf6568996c8c0ea454f5e0f2fa90973c571f7ae9cdee218107 AS cache
WORKDIR /app
ENV GRADLE_USER_HOME /app/gradle
COPY *.gradle.kts gradle.properties /app/
RUN gradle shadowJar --parallel --console=verbose

FROM gradle:8.5.0-jdk17@sha256:30f979b5b89a14bf6568996c8c0ea454f5e0f2fa90973c571f7ae9cdee218107 AS build
WORKDIR /app
