FROM gradle:9.2.0-jdk17@sha256:91ece2aa1a6288c74effe3fd2b664c1da3020c3239ae6352131c6423f65a41d8 AS cache
WORKDIR /app
ENV GRADLE_USER_HOME /app/gradle
COPY *.gradle.kts gradle.properties /app/
RUN gradle shadowJar --parallel --console=verbose

FROM gradle:9.2.0-jdk17@sha256:91ece2aa1a6288c74effe3fd2b664c1da3020c3239ae6352131c6423f65a41d8 AS build
WORKDIR /app
