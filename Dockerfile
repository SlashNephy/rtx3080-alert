FROM gradle:9.1.0-jdk17@sha256:ea24a69916fbe8840f85a0a7df253cd3c3d821adda1f6023ee10dcbe471c85d5 AS cache
WORKDIR /app
ENV GRADLE_USER_HOME /app/gradle
COPY *.gradle.kts gradle.properties /app/
RUN gradle shadowJar --parallel --console=verbose

FROM gradle:9.1.0-jdk17@sha256:ea24a69916fbe8840f85a0a7df253cd3c3d821adda1f6023ee10dcbe471c85d5 AS build
WORKDIR /app
